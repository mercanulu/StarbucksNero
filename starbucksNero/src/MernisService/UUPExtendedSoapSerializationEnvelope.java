...
public class UUPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(UUPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new UUPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static UUPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static UUPDateTimeConverter dateTimeConverter = new UUPStandardDateTimeConverter();

    public UUPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public UUPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new UUPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=UUPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,UUPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=UUPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
