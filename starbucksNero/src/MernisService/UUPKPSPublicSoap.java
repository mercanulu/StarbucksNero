...
public class UUPKPSPublicSoap
{
    ...
    public UUPKPSPublicSoap(){}

    public UUPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public UUPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        UUPExtendedSoapSerializationEnvelope envelope= new UUPExtendedSoapSerializationEnvelope(UUPExtendedSoapSerializationEnvelope.VER11);
